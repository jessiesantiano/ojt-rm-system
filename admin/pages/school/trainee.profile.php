                ...
                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <a target="_blank" class="px-2 font-bold text-center uppercase align-middle shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/process.php?view_id=' . $id . '"><i class="mr-1 far fa-eye "></i>View</a>
                          <a class="font-bold text-center uppercase align-middle shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/process.php?download_id=' . $id . '"><i class="mr-1 fa fa-download"></i>Download</a>
                        </td>';
                      }
                ...
                <table class="items-center w-full mb-0 align-top border-gray-200 ">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <a target="_blank" class="px-2 font-bold text-center uppercase align-middle bg-transparent shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/process.php?view_id=' . $id . '"><i class="mr-1 far fa-eye "></i>View</a>
                          <a class="font-bold text-center uppercase align-middle shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/process.php?download_id=' . $id . '"><i class="mr-1 fa fa-download"></i>Download</a>
                        </td>';
                      }
                    } else echo '<section class="flex items-center h-full p-5  dark:text-gray-100">
...
';
                  ...
                  <td class="p-1 text-center justify-content-center bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <a target="_blank" href="../students/process.php?viewR_id=' . $id . '" class="px-2 font-bold text-center uppercase align-middle shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View </a>
                    <a href="../students/process.php?downloadR_id=' . $id . '" class="px-2 font-bold text-center uppercase align-middle shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-blue-400"> <i class="fa fa-download" aria-hidden="true"></i> &nbsp;Download </a>
';
                  ...
                  <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
                   ...
                   echo '   
                    ...
                    <div class="ml-auto text-right">
                      <a target="_blank" class="px-3 font-bold text-center uppercase align-middle shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/eval_process.php?view_id='.$id.'"><i class="mr-2 far fa-eye bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>View</a>
                      <a class="px-3 font-bold text-center uppercase align-middle shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/eval_process.php?download_id='.$id.'"><i class="mr-2 fa fa-download bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>Download</a>
                      ';
                     if ($_SESSION['accountFor'] == 'Coordinator') {
                        echo '';
                      } else echo '
                      <a class="font-bold text-center uppercase align-middle shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-blue-400" href="../students/eval_process.php?delete_id=' . $id . '"><i class="mr-2 fa fa-trash bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>Delete</a>
                    '; ?>
                    </div>
                  </li>
                <?php }
