                ...
                while ($row = mysqli_fetch_array($result)) { ?>
                 <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
                   ...
                   <div class="ml-auto text-right">
                     ...
                     <a class="relative inline-block px-4 py-3 mb-0 font-bold text-center text-transparent uppercase align-middle transition-all border-0 rounded-lg shadow-none cursor-pointer leading-pro text-xs ease-soft-in bg-800 bg-gradient-to-tl from-blue-600 to-blue-200 hover:scale-102 active:opacity-85 bg-x-25 bg-clip-text" href="./process.php?download_id=<?php echo $row['id'] ?>"><i class="mr-2 fa fa-download bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>Delete</a>
                   </div>
                 </li>
               <?php } ?>
             </ul>
