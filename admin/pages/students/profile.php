            ...
            while ($row = mysqli_fetch_array($result)) { ?>
              <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
                ...
                <div class="ml-auto text-right">
                  <a target="_blank" class="font-semibold leading-tight text-xs uppercase text-slate-400 px-3" href="./process.php?view_id=<?php echo $row['id'] ?>"><i class="mr-2 far fa-eye bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>View</a>
                  <a class="font-semibold leading-tight text-xs uppercase text-slate-400 px-3" href="./process.php?download_id=<?php echo $row['id'] ?>"><i class="mr-2 fa fa-download bg-150 bg-blue-600 bg-x-25 bg-clip-text"></i>Download</a>
                </div>
              </li>
            <?php } ?>
          </ul>
                ...
                while ($rep = mysqli_fetch_array($result)) { ?>
                  <tr>
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <div class="flex px-6 py-1">
                        <div class="flex flex-col justify-center">
                          <h6 class="mb-0 leading-normal text-sm"><?php echo $rep['title']; ?></h6>
                          <p class="mb-0 leading-tight text-xs text-slate-400"><?php echo $rep['name']; ?></p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <span class="font-semibold leading-tight text-xs text-slate-400"><?php $date = DateTime::createFromFormat('Y-m-d H:i:s', $rep['date']);
                    ...
                    <td class="p-1 align-center justify-content-center bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <a target="_blank" href="./process.php?viewR_id=<?php echo $rep['id'] ?>" class="font-semibold leading-tight text-sm text-slate-400 px-3"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View </a>
                      <a href="./process.php?downloadR_id=<?php echo $rep['id'] ?>" class="font-semibold leading-tight text-sm text-slate-400 px-3"> <i class="fa fa-download" aria-hidden="true"></i> &nbsp;Download </a>

                      <?php
                      if ($rep['status'] == 'pending') {
                        echo "<a href='#check_id" . $rep['id'] . "' data-toggle='modal' href='' class='font-semibold leading-tight text-sm text-slate-400'><i class='fa fa-check-circle'></i> &nbsp;Mark as check </a>";
                      } elseif ($rep['status'] == 'checked') {
                      }
                      ?>
